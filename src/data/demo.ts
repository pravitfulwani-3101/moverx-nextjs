...
export const DEMO_PATIENTS: Patient[] = [
  { id:"p1", name:"Rajesh Sharma",    age:45, phone:"+91 98201 XXXXX", condition:"Post ACL Repair",      sport:"Cricket",          occupation:"", dominantHand:"Right", lifestyle:"Active", complaintP1:"", complaintP2:"", complaintP3:"", adherence:85, sessions:8,  avatar:"RS", status:"active",  prescribedExercises:["k1","k2","k3","h1","h2"], venue:"Private Session" },
  { id:"p2", name:"Priya Nair",       age:32, phone:"+91 98765 XXXXX", condition:"Frozen Shoulder (R)",  sport:"Badminton",        occupation:"", dominantHand:"Right", lifestyle:"Active", complaintP1:"", complaintP2:"", complaintP3:"", adherence:62, sessions:12, avatar:"PN", status:"active",  prescribedExercises:["s1","s2","s4"], venue:"Gold's Gym" },
  { id:"p3", name:"Amit Patel",       age:58, phone:"+91 99876 XXXXX", condition:"Lumbar Disc L4-L5",    sport:"General Fitness",  occupation:"", dominantHand:"Right", lifestyle:"Sedentary", complaintP1:"", complaintP2:"", complaintP3:"", adherence:91, sessions:15, avatar:"AP", status:"active",  prescribedExercises:["b3","b4","b2","h2"], venue:"MBD" },
  { id:"p4", name:"Sneha Kulkarni",   age:27, phone:"+91 98345 XXXXX", condition:"Tennis Elbow",         sport:"Tennis",           occupation:"", dominantHand:"Right", lifestyle:"Active", complaintP1:"", complaintP2:"", complaintP3:"", adherence:45, sessions:4,  avatar:"SK", status:"at-risk", prescribedExercises:["w1","w2","s5"], venue:"Private Session" },
  { id:"p5", name:"Kavita Desai",     age:35, phone:"+91 97654 XXXXX", condition:"Runner's Knee",        sport:"Marathon",         occupation:"", dominantHand:"Right", lifestyle:"Active", complaintP1:"", complaintP2:"", complaintP3:"", adherence:94, sessions:10, avatar:"KD", status:"active",  prescribedExercises:["k1","k4","h1","h3","a1"], venue:"Gold's Gym" },
  { id:"p6", name:"Arjun Menon",      age:19, phone:"+91 96543 XXXXX", condition:"Ankle Sprain Grade 2", sport:"Football",         occupation:"", dominantHand:"Right", lifestyle:"Active", complaintP1:"", complaintP2:"", complaintP3:"", adherence:55, sessions:3,  avatar:"AM", status:"at-risk", prescribedExercises:["a1","a2","a3","h1"], venue:"MBD" },
];
